...
\begin{frame}[c]
    \frametitle{Accessing the code}
      ...
      \bigskip
      The latex document and R code for reproducing this presentation (including most of the plots):\\
...
\begin{frame}[t]
  ...
  The assumption that a set of radiocarbon dates can tell us something about past population size.
\end{frame}
...
%----------- slide --------------------------------------------------%
\begin{frame}[t]
  \frametitle{Conceptually, what are we choosing among when we summarize the dates?}
  \begin{itemize}
...
%----------- slide --------------------------------------------------%
\begin{frame}[t]
  \frametitle{Fundamental flow of inference: SPDs [actual plot]}
    \includegraphics[height=.85\textheight]{spd_flow.pdf}
\end{frame}
